...
class TestDilatedMaxPool3dMethod:
    ...
    def test_dilated_maxpool3d(
        ...
        y_cpu = torch.nn.functional.max_pool3d_with_indices(
            x_cpu,
        ...
        y_supa = torch.nn.functional.max_pool3d_with_indices(
            x_supa,
            kernel_size=kernel_shape,
            stride=stride,
            padding=padding,
