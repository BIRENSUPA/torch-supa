...
class TestLaguerrePolynomialLMethod:

    @pytest.mark.parametrize("shape", br200_shape)
    @pytest.mark.parametrize("dtype", dtypes)
    def test_laguerre_polynomial_l(self, shape, dtype):
        ...
        output_cpu = torch.special.laguerre_polynomial_l(in_cpu, in_cpu2)
        output_supa = torch.special.laguerre_polynomial_l(in_supa, in_supa2)
