...
class TestForeachTernaryMethod:
    ...
    def test_foreach_ternary_op(self, shape, func_type, dtype):
        ...
        res_cpu = pt_func(in_cpu_list1, in_cpu_list2, in_cpu_list3)
        res_supa = pt_func(in_supa_list1, in_supa_list2, in_supa_list3)
