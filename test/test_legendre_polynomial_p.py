...
class TestLegendrePolynomialPLMethod:

    @pytest.mark.parametrize("shape", br200_shape)
    @pytest.mark.parametrize("dtype", dtypes)
    def test_legendre_polynomial_p(self, shape, dtype):
        ...
        output_cpu = torch.special.legendre_polynomial_p(in_cpu, in_cpu2)
        output_supa = torch.special.legendre_polynomial_p(in_supa, in_supa2)
