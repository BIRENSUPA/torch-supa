...
TOTAL_NUM_PREFETCH_FOR_PRE = 4
TOTAL_NUM_PREFETCH_FOR_POST = 3
ENCODER_BEGIN_INDEX_FOR_PRE = 2
ENCODER_BEGIN_INDEX_FOR_POST = 1
ENCODER_PREFETCH_NUM = 1
...
class TestBackwardPrefetch(FSDPTest):
    ...
    def _dist_train(self, backward_prefetch=BackwardPrefetch.BACKWARD_PRE):
        ...
        src = torch.randn((2, 1, 4), device=device_type)
        tgt = torch.randn((4, 1, 4), device=device_type)
