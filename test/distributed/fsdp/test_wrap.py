...
class BatchNormNet(nn.Module):
    def __init__(self) -> None:
        ...
        self.sync_bn = nn.SyncBatchNorm(4)
...
class LoraModel(nn.Module):
    ...
    def __init__(self) -> None:
        ...
        self.layers = nn.ModuleList([LoraDecoder() for _ in range(2)])
...
class LoraDecoder(nn.Module):
    def __init__(self) -> None:
        ...
        self.mlp = LoraMLP()
        self.inp_layernorm = nn.LayerNorm(4)
        self.post_attn_layernorm = nn.LayerNorm(4)
...
class LoraAttention(nn.Module):
    def __init__(self) -> None:
        ...
        self.lora_A = nn.Linear(4, 8, bias=False)
        self.lora_B = nn.Linear(8, 4, bias=False)
...
class LoraMLP(nn.Module):
    def __init__(self) -> None:
        super().__init__()
        self.proj1 = nn.Linear(4, 4, bias=False)
        self.proj2 = nn.Linear(4, 4, bias=False)
