...
class TestHermitePolynomialHEMethod:

    @pytest.mark.parametrize("shape", br200_shape)
    @pytest.mark.parametrize("dtype", dtypes)
    def test_hermite_polynomial_h(self, shape, dtype):
        ...
        output_cpu = torch.special.hermite_polynomial_he(in_cpu, in_cpu2)
        output_supa = torch.special.hermite_polynomial_he(in_supa, in_supa2)
