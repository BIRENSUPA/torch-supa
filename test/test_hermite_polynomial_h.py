...
class TestHermitePolynomialHMethod:
    ...
    def test_hermite_polynomial_h(self, shape, dtype):
        ...
        output_cpu = torch.special.hermite_polynomial_h(in_cpu, in_cpu2)
        output_supa = torch.special.hermite_polynomial_h(in_supa, in_supa2)
