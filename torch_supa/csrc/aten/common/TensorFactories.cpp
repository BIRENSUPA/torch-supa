...
at::Tensor SUPANativeFunctions::empty(
    IntArrayRef size, optional<ScalarType> dtype_opt,
    optional<Layout> layout_opt, optional<Device> device_opt,
    optional<bool> pin_memory_opt, optional<MemoryFormat> memory_format_opt) {
  auto result = at::detail::empty_supa(size, dtype_opt, layout_opt, device_opt,
                                       pin_memory_opt, memory_format_opt);
  return result;
}

at::Tensor SUPANativeFunctions::empty_strided(IntArrayRef size,
                                              IntArrayRef stride,
                                              optional<ScalarType> dtype_opt,
                                              optional<Layout> layout_opt,
                                              optional<Device> device_opt,
                                              optional<bool> pin_memory_opt) {
  auto result = at::detail::empty_strided_supa(
