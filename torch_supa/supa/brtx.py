...
r"""This package adds support for Biren Tools Extension (BRTX) used in profiling."""

from contextlib import contextmanager


try:
    from torch_supa._C import _brtx
except ImportError:
    ...
    class _BRTXStub:
        ...
        def _fail(*args, **kwargs):
            raise RuntimeError(
                "BRTX functions not installed. Are you sure you have a BRTX library?"
            )
    ...
    _brtx = _BRTXStub()  # type: ignore[assignment]
...
def _device_range_start(msg: str, stream: int = 0) -> object:
    ...
    """
    return _brtx.deviceRangeStart(msg, stream)
...
def _device_range_end(range_handle: object, stream: int = 0) -> None:
    ...
    Args:
        ...
        stream (int): CUDA stream id.
    """
    _brtx.deviceRangeEnd(range_handle, stream)
...
def mark(msg):
    ...
    """
    return _brtx.markA(msg)


@contextmanager
def range(msg, *args, **kwargs):
    """
    Context manager / decorator that pushes a BRTX range at the beginning
